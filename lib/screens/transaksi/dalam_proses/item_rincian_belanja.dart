...
class ItemRincianBelanja extends StatefulWidget {
  const ItemRincianBelanja(
      {super.key, required this.idTransaksi, required this.data});
...
class _ItemRincianBelanjaState extends State<ItemRincianBelanja> {
  ...
  Widget build(BuildContext context) {
    ...
    int qty = transaksiProvider
        .listTransaksi[widget.idTransaksi].listProduk[produk.id];
                        ...
                        TextButton(
                            onPressed: () {
                              QuickAlert.show(
                                  ...
                                  showCancelBtn: true,
                                  onConfirmBtnTap: () {
                                    transaksiProvider.cancelCartItem(
                                        widget.idTransaksi, produk.id);
